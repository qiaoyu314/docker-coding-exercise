...
var ProductList = React.createClass({displayName: 'ProductList',
	render: function(){
		...
		this.props.data.forEach(function(product){
			Productrow.push(React.createElement(Product, {productName: product.name, vendor: product.vendor, productImage: product.image, rating: product.rating, category: product.category}));
		});
		return (
...
React.render(React.createElement(ProductList, {data: data}), document.body);
},{"./Product.jsx":2,"react":148}],2:[function(require,module,exports){
/** @jsx React.DOM */
	...
	render: function(){
		return (
			React.createElement("tr", null, 
				React.createElement("td", {className: "product-image"}, 
					React.createElement("img", {src: this.props.productImage})
				), 
				React.createElement("td", {className: "product-info"}, 
					React.createElement("div", {className: "product-info-left"}, 
						React.createElement("div", {className: "product-name"}, this.props.productName), 
						React.createElement("div", {className: "proudct-vendor"}, this.props.vendor), 
						React.createElement("div", {className: "product-price"}, this.props.price)
					), 
					React.createElement("div", {className: "product-info-right"}, 
						React.createElement("div", {className: "product-rating"}, "Rating: ", this.props.rating), 
						React.createElement("div", {className: "proudct-category"}, this.props.category)
					)
				)
			)
		)
